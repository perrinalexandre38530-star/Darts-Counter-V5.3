// ============================================
// src/pages/X01PlayV2.tsx (OPTION A CLEAN)
// Copie de X01Play A-CLEAN pour la V2
// - UI 100% identique
// - Moteur useX01Engine
// - AUTOSAVE séparé (dc-x01-v2-autosave-v1)
// ============================================
...
/* ===================================================================== 
   TRAINING-LIKE SAVE FOR NORMAL X01 V2
...
/* ==================== AUTOSAVE V2 ==================== */
const AUTOSAVE_KEY = "dc-x01-v2-autosave-v1";
...
function LegBannerModal(props: LegBannerProps) {
  ...
  if (isDuel) {
    ...
    if (other) {
      ...
      const otherLegsAfter = otherLegsBefore;
...
/* ======================================================================
   X01Core — cœur du jeu (identique à X01Play A-CLEAN)
====================================================================== */
function X01Core({
  profiles,
  playerIds,
  ...
  async function finalizeMatch() {
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "[X01PlayV2] History.upsert (summaryForHistory) failed",
          err
        );
      }
