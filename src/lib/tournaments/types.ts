...
export type TournamentGameSettings = {
  mode: TournamentMode;
  // On stocke les configs "mode" telles quelles pour réutiliser ton existant
  // (X01 V1 / X01 V3 / Cricket / Killer / Clock).
  // Tu brancheras ensuite chaque page de config.
...
export type TournamentMatch = {
  ...
  roundIndex: number; // pour single elim
